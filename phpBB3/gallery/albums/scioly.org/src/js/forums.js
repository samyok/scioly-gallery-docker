/*
	Filepath:    /var/www/html/src/js/forums.js
	Description: Referenced by pages of the Forums (/var/www/html/forums/) to enable common sitewide Javascript functionalities.
	Author:      bernard
...
$(document).ready(function() {
	$('div#wrap').css("min-height", ($(window).outerHeight() - $('div.site-footer').outerHeight() - $('div.site-nav').outerHeight()));
});
